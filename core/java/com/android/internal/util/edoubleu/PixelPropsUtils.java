...
package com.android.internal.util.edoubleu;
...
import com.android.internal.util.edoubleu.EdoubleuUtils;
...
public class PixelPropsUtils {
    ...
    private static final String DEVICE = "ro.edoubleu.device";
    ...
    public static void spoofBuildGms(Context context) {
        ...
        if (!EdoubleuUtils.isPackageInstalled(context, packageName)) {
