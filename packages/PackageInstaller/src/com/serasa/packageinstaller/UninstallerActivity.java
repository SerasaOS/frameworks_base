 ...
 */
package com.serasa.packageinstaller;
...
import com.serasa.packageinstaller.handheld.ErrorDialogFragment;
import com.serasa.packageinstaller.handheld.UninstallAlertDialogFragment;

import java.util.List;

import static android.app.AppOpsManager.MODE_ALLOWED;
import static com.serasa.packageinstaller.PackageUtil.getMaxTargetSdkVersionForUid;

/*
 * This activity presents UI to uninstall an application. Usually launched with intent
 * Intent.ACTION_UNINSTALL_PKG_COMMAND and attribute
 * com.serasa.packageinstaller.PackageName set to the application package name
 */
