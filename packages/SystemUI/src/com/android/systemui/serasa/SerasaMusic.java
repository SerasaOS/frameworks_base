...
public class SerasaMusic extends RelativeLayout implements NotificationMediaManager.MediaListener, Palette.PaletteAsyncListener {
   private static final boolean DEBUG = true;
   private static final String TAG = "SerasaMusic";
   ...
   private SerasaMusic mBackground;

   public SerasaMusic(Context context) {
       this(context, null);
   }

   public SerasaMusic(Context context, AttributeSet attrs) {
       this(context, attrs, 0);
   }

   public SerasaMusic(Context context, AttributeSet attrs, int defStyleAttr) {
       this(context, attrs, defStyleAttr, 0);
   }

   public SerasaMusic(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
