...
import com.android.internal.util.serasa.OmniJawsClient
...
class WeatherTile @Inject constructor(
    ...
    override fun getMetricsCategory(): Int {
        return MetricsEvent.SERASA_QS_TILES
    }
    ...
    override fun handleClick(@Nullable view: View?) {
        ...
        if (!mState.value || mWeatherData == null) {
            ...
            for (app in ALTERNATIVE_WEATHER_APPS) {
                if (SerasaUtils.isPackageInstalled(mContext, app)) {
            ...
            if (SerasaUtils.isPackageInstalled(mContext, "com.google.android.googlequicksearchbox")) {
